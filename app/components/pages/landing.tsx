...
export default function Landing() {
  const heroImageUrl = getStaticPhotoUrl(
    'start-page-miles.jpg',
  ...
  return (
    <div
      id="landing"
      className="texture-overlay flex h-svh w-full snap-start snap-normal flex-col items-center justify-between overflow-hidden md:snap-align-none md:flex-row md:items-stretch"
    >
